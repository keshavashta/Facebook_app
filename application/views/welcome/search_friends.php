    ...
    <div class="span12">
        ...
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td>
                    <a href="#" class="send" id="send-<?php echo $row->user_id;?>"
                       data-id="<?php echo $row->user_id;?>">Post Blood Req Message</a>

                    <p class="no-display" id="send-img-<?php echo $row->user_id;?>"><img
                        src="<?php echo base_url('/assets/img/OK.png')?>" alt=""></p>

                    <p class="no-display" id="ajax-loader-img-<?php echo $row->user_id;?>"><img
                        src="<?php echo base_url('/assets/img/ajax-loader.gif')?>" alt=""></p>
                </td>
